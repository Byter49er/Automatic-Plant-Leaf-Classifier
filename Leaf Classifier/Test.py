...
def main():
    ...
    if oneOrAll == "yes":
        ...
        for i in range(len(image_dir_list)):
            ...
            for j in range(len(images)):
             if (not(images[j] == "Thumbs.db")):
               ...
               predictedClass = most_freq(model.predict(features))
        ...
        print(str(correctClassCount)+" correct classifications out of "+str(totImgs))
        print(str((correctClassCount/totImgs)*100)+"% test accuracy")
    else:
